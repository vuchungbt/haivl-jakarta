...
<%--                        <div class="col-sm-6 col-lg-4">--%>
                          ...
                          <input type="text" class="form-control" placeholder="" value="${userModel.name}" readonly>
                        </div>
<%--                        <!-- Last name -->--%>
<%--                        <div class="col-sm-6 col-lg-4">--%>
...
<%--                        </div>--%>
                        ...
                        <div class="col-sm-6">
                          ...
                          <input type="text" name = "tel" class="form-control" placeholder="" value="${userModel.tel}">
                          <!-- Add new number -->
<%--                          <a class="btn btn-sm btn-dashed rounded mt-2" href="#!"> <i class="bi bi-plus-circle-dotted me-1"></i>Add new phone number</a>--%>
                        ...
                        <div class="col-sm-6">
                          ...
                          <input type="text" class="form-control" placeholder="" value="${userModel.email} " readonly>
                          <!-- Add new email -->
<%--                          <a class="btn btn-sm btn-dashed rounded mt-2" href="#!"> <i class="bi bi-plus-circle-dotted me-1"></i>Add new email address</a>--%>
                        ...
                        <div class="col-12">
                          ...
                          <textarea name = "description" class="form-control" rows="4" placeholder="Description (Required)">${userModel.description}</textarea>
                          <small>Character limit: 300</small>
                        </div>
                        <!-- Button  -->
                        <div class="col-12 text-end">
                          <button type="submit" id="btnSaveProfile" class="btn btn-sm btn-primary mb-0">Save changes</button>
                        </div>
                      </form>
                      <!-- Settings END -->
                    </div>
  ...
  <script>
    $(document).ready(function (){
      $('#btnSaveProfile').click(function (e){
        e.preventDefault();
        let data = {};
        let formData = $('#formProfile').serializeArray();
        ...
        $.ajax({
          ...
          error:function (){
            window.location.href = getBaseUrl() + "?message=error-edit-profile&alert=danger";
          }
        })
