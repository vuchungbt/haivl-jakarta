                    ...
                    <div class="row">
                      <div class="d-flex justify-content-between p-2 px-3">
                        <div class="d-flex flex-row align-items-center">
                          ...
                          <h5 class="m-1">
                            <a href="#"> Comedy on the green Comedy on the greenComedy on
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-8">
                        <div class="p-2 content-container mb-4">
                             <p class="text-justify content">Comedy on the gre
                             en Comedy on the greenComedy on the greenComedy on the greenComedy on the greenComedy on the green</p>
                         </div>
